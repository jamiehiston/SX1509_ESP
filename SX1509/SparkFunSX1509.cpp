...
******************************************************************************/
//add i2c library to replace wire.h so it works on ESP-IDF
//#include <Wire.h>
//#include "Arduino.h"
...
void SX1509::reset(bool hardware)
{
	...
	if (hardware)	//not able to do this in ESP, just do a software reset
	{
...
void SX1509::sync(void)
{
	...
	//ets_delay_us(1000);					  // Wait for the pin to settle
	//digitalWrite(pinReset, HIGH); // pull reset pin back high
